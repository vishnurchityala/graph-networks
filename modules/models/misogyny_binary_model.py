...
class MisogynyBinaryModel(nn.Module):
    def __init__(self,
                 lda_weights_path=("weights/combined_lda_binary_mean.npy", "weights/combined_lda_binary_coef.npy"),
                 # 400-dim PCA weights (files without dimension suffix)
                 pca_weights_path_text=("weights/bert_pca_binary_components.npy", "weights/bert_pca_binary_mean.npy"),
                 pca_weights_path_image=("weights/clip_pca_binary_components.npy", "weights/clip_pca_binary_mean.npy"),
                 pca_output_dim_text: int | None = 400,
                 pca_output_dim_image: int | None = 400,
                 graph_weights_path="weights/graph_binary_module.pth",
                 device=None,
...
class MisogynyBinaryModelNoGraph(nn.Module):
...
class MisogynyBinaryModelPCAOnly(nn.Module):
